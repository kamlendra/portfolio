...
- [composer](https://packagist.org/packages/kamlendrasharma/venobox): `composer require kamlendrasharma/venobox`
- [yarn](https://yarnpkg.com/en/package/venobox): `yarn add venobox`

### Static HTML

Download the [latest release](https://github.com/kamlendrasharma/VenoBox/releases)
